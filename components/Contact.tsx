      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-slate-500 max-w-2xl mx-auto text-lg">
            Open to full-time experienced roles in Data Science, Data Analytics and Software Development that are
            frontend heavy. Let's collaborate and work together!
          </p>
        </motion.div>
